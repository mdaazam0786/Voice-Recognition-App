...
@Composable
fun LanguageScreen(
    languageViewModel: LanguageScreenViewModel = hiltViewModel(),
    popBackStack: () -> Unit,
            ...
            LazyColumn(
                ...
                stickyHeader {
                    TextField(
                        ...
                        onValueChange = {
                            languageViewModel.onLanguageEvent(LanguageScreenEvent.onTextFieldClick(it))
                        },
                        modifier = Modifier
                            .fillMaxWidth()
                            .height(100.dp)
                        ...
                        trailingIcon = {
                            IconButton(onClick = {
                                languageViewModel.onLanguageEvent(LanguageScreenEvent.onSpeakClick(languageViewModel.state.value.text, context))
                            },
                    ...
                    Row(
                        ...
                        Card(
                            modifier = Modifier
                                .size(100.dp)
                                .clickable {
                                    languageViewModel.onLanguageEvent(LanguageScreenEvent.onTeluguClick)
                                },
                            colors = CardDefaults.cardColors(Color(0xff658afc))
                        ...
                        Card(
                            modifier = Modifier
                                .size(100.dp)
                                .clickable {
                                    languageViewModel.onLanguageEvent(LanguageScreenEvent.onKannadaClick)
                                },
                            colors = CardDefaults.cardColors(Color(0xff658afc))
                    ...
                    Row(
                        ...
                        Card(
                            modifier = Modifier
                                .size(100.dp)
                                .clickable {
                                    languageViewModel.onLanguageEvent(LanguageScreenEvent.onMarathiClick)
                                },
                            colors = CardDefaults.cardColors(Color(0xff658afc))
                        ...
                        Card(
                            modifier = Modifier
                                .size(100.dp)
                                .clickable {
                                    languageViewModel.onLanguageEvent(LanguageScreenEvent.onGujratiClick)
                                },
                            colors = CardDefaults.cardColors(Color(0xff658afc))
